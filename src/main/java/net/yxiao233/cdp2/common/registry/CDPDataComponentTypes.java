...
public class CDPDataComponentTypes {
    ...
    public static final DeferredHolder<DataComponentType<?>,DataComponentType<CompoundTag>> COMPOUND_TAG = DATA_COMPONENTS.register("compound_tag",() -> DataComponentType.<CompoundTag>builder().persistent(CompoundTag.CODEC).networkSynchronized(CodecHelper.fromCodec(CompoundTag.CODEC)).build());
}
